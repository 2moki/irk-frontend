                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div v-if="!formData.hasCustomSchool" class="w-full">
                        <AutoComplete
                            ...
                            dropdown
                            class="w-full"
                            :class="{ 'p-invalid': errors.school_id }"
                        />
                        <small v-if="errors.school_id" class="p-error block mt-1">{{ errors.school_id }}</small>
                    </div>
                    ...
                    <div v-else class="w-full">
                        ...
                        />
                        <small v-if="errors.school_custom_name" class="p-error block mt-1">{{ errors.school_custom_name }}</small>
                    </div>
            ...
            <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <small v-if="errors.maturityType" class="p-error block mt-1">{{ errors.maturityType }}</small>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <small v-if="errors.country_id && isForeignMatura" class="p-error block mt-1">{{ errors.country_id }}</small>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <small v-if="errors.docNumber" class="p-error block mt-1">{{ errors.docNumber }}</small>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <small v-if="errors.docYear" class="p-error block mt-1">{{ errors.docYear }}</small>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <small v-if="errors.docIssuer" class="p-error block mt-1">{{ errors.docIssuer }}</small>
                    </div>
                </div>
...
const validateForm = () => {
    ...
    if (!formData.maturityType) {
        errors.maturityType = 'To pole jest wymagane.';
        isValid = false;
    }
