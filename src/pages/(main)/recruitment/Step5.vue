...
<template>
    <div class="mx-auto max-w-4xl p-6 text-slate-800">
        <div class="mb-2 flex items-end justify-between">
            <div>
                <span class="text-xs font-bold tracking-wider text-blue-600 uppercase">KROK 5 Z 10</span>
                <h1 class="mt-1 text-2xl font-bold text-[#1d2d5b]">Zdjęcie do legitymacji</h1>
            </div>
            <span class="text-xs font-medium text-gray-400">Postęp aplikacji</span>
        </div>

        <div class="mb-8 h-2 w-full rounded-full bg-gray-200">
            <div class="h-2 rounded-full bg-[#1d2d5b] transition-all duration-300" style="width: 50%"></div>
        </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="w-full flex-1">
                    ...
                    <p class="mt-1 mb-6 text-sm text-gray-500">
                        Wgraj aktualne zdjęcie spełniające wymagania zdjęcia do dowodu osobistego lub paszportu (format
                        JPG lub PNG, maksymalny rozmiar pliku to 2MB).
                    </p>
                    ...
                    <div class="mx-auto max-w-md">
                        ...
                        >
                            <div class="h-52 w-40 overflow-hidden rounded-lg border border-gray-300 bg-white shadow-md">
