    ...
    <div class="mx-auto w-full max-w-6xl p-4 text-slate-800 transition-colors duration-200 md:p-8 dark:text-slate-100">
        ...
        <div v-else class="animate-fade-in space-y-8">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    class="flex items-center gap-4 rounded-xl border border-gray-100 bg-white p-4 shadow-sm dark:border-slate-700/60 dark:bg-slate-800"
                >
                    <div
                ...
                >
                    <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-purple-50 text-purple-600 dark:bg-purple-950/40 dark:text-purple-400"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5"
                    ...
                    <div>
                        <span class="block text-xs font-medium text-gray-400 dark:text-gray-500"
                            >Forma kształcenia</span
                        >
                        <span class="text-sm font-bold text-gray-700 dark:text-gray-200">{{
                            course.study_mode ?? 'Stacjonarne'
                        }}</span>
                    </div>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <span class="text-sm font-bold text-gray-700 dark:text-gray-200"
                            >{{ course.semesters }} semestrów</span
                        >
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div class="space-y-6 lg:col-span-2">
                    <div
                        class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800"
                    >
                        ...
                        <p class="mt-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                            ...
                            oferuje wszechstronne wykształcenie dopasowane do aktualnych potrzeb rynku pracy. Program
                            kładzie nacisk zarówno na gruntowne przygotowanie teoretyczne, jak i rozwijanie umiejętności
                            praktycznych niezbędnych w przyszłej pracy zawodowej.
                        </p>
                    </div>
                    ...
                    >
                        <div class="mb-4 flex items-center gap-2">
                            ...
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 0c-.813 2.146-2.185 4.16-4 5.5m3.712-5.5a14.197 14.197 0 00-2.312-3.667M7 19l2.712-6.78M12 19l-2.712-6.78L7 19z"
                                />
                            </svg>
                        ...
                        <div v-if="course.languages && course.languages.length > 0">
                            ...
                            <div class="flex flex-wrap gap-2.5">
                                <span
                                    ...
                                    :key="lang.id"
                                    class="inline-flex items-center gap-1.5 rounded-xl border border-blue-100/50 bg-blue-50/80 px-4 py-2 text-sm font-semibold text-blue-700 dark:border-blue-900/30 dark:bg-blue-950/40 dark:text-blue-300"
                                >
                        ...
                        <div
                            v-else
                            class="rounded-xl border border-dashed border-gray-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/50"
                        >
                            <p class="text-sm text-gray-500 italic dark:text-gray-400">
                                Wybór lektoratu odbywa się zazwyczaj na etapie składania dokumentów rekrutacyjnych lub
                ...
                <div class="space-y-6">
                    <div
                        class="rounded-2xl border border-gray-100 bg-[#f8fafc] p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900"
                    >
                        <h3 class="text-sm font-bold text-[#11224d] dark:text-slate-200">Status rekrutacji</h3>

                        <div
                            v-if="hasRecruitmentDates"
                            class="mt-4 space-y-3 rounded-xl border border-gray-100 bg-white p-4 dark:border-slate-700 dark:bg-slate-800"
                        >
                            <div
                                class="flex items-center gap-2 text-xs font-semibold text-emerald-600 dark:text-emerald-400"
                            >
                            ...
                            <div class="space-y-2 pt-1">
                                ...
                                <div v-if="getEndDate" class="text-xs">
                                    <span class="block font-medium text-gray-400 dark:text-gray-500"
                                        >Zakończenie przyjmowania zgłoszeń:</span
                                    >
                        ...
                        <p v-else class="mt-2 text-xs leading-relaxed text-gray-500 dark:text-gray-400">
                            Rekrutacja na ten kierunek jest otwarta. Ostatnia aktualizacja oferty miała miejsce:
                            <span class="font-medium text-slate-700 dark:text-slate-300">{{
                                course.updated_at?.human || 'niedawno'
                            }}</span
                            >.
                        </p>
                        ...
                        <h3 class="text-sm font-bold text-[#11224d] dark:text-slate-200">
