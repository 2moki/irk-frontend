...
const submitDocuments = async () => {
    ...
    try {
        ...
        // Po udanym uplodzie idziemy dalej
        router.push('/application/language-selection');
    } catch (error: any) {
...
<template>
    <div class="mx-auto w-full max-w-5xl text-slate-800 transition-colors duration-200 dark:text-slate-100">
        <ApplicationHeader :current-step="4" :steps="10" title="Skany dokumentów" subtitle="Wymagane dokumenty" />
        ...
        <div class="mt-8 space-y-6">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="w-full flex-1">
                        ...
                        <p class="mt-1 mb-6 text-sm text-gray-500">
                            ...
                            świadectwo dojrzałości). Akceptowane formaty: PDF, JPG, PNG. Maksymalny rozmiar jednego
                            pliku: 5MB.
                        </p>
            ...
            <div class="flex items-center justify-between">
                <Button
                    ...
                    @click="router.push('/application/photo')"
                />
                <Button
